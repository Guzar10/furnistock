    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <h1 className="font-serif text-4xl font-light text-text mb-2">
        ...
        <div className="bg-bg-surface border border-border rounded-xl p-8">
          <h2 className="text-lg font-medium text-text mb-6">Autentificare</h2>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                placeholder="admin@furnistock.ro"
                required
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 bg-accent text-bg font-medium py-2.5 rounded-md text-sm hover:bg-accent/90 transition-colors disabled:opacity-50"
            >
